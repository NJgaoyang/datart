...
class ChartManager {
  ...
  private _basicCharts(): IChart[] {
    return [
      ...
      createMixedChart('bar-line'),
      createMixedChart('group'),
      createMixedChart('stack'),
      createMixedChart('dual-line'),
      new QuadrantChart(),
      new BidirectionalBarChart(),
      new BulletChart(),
      new CirclePackingChart(),
      new FlowMapChart(),
      new HeatMapChart(),
      new LiquidChart(),
      new PictureGroup(),
