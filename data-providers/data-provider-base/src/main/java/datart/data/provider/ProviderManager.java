...
public class ProviderManager extends DataProviderExecuteOptimizer implements DataProviderManager {
    ...
    @Override
    public String renderSql(DataProviderSource source, QueryScript queryScript, ExecuteParam param) throws Exception {
        return getDataProviderService(source.getType()).renderSql(source, queryScript, param);
    }
