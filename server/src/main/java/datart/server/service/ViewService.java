...
import datart.server.base.params.ViewComposeParam;
...
public interface ViewService extends VizCRUDService<View, ViewMapperExt>, ResourceTransferService<View, ViewResourceModel, TransferModel, Folder> {
    ...
    ViewComposeResult compose(ViewComposeParam param) throws Exception;

    ViewLineageDTO getLineage(String viewId);
