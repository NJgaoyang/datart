...
public abstract class DataProvider extends AutoCloseBean {
    ...
    public String renderSql(DataProviderSource config, QueryScript script, ExecuteParam executeParam) throws Exception {
        throw new UnsupportedOperationException("SQL rendering is not supported by provider " + getType());
    }
